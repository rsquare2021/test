            ...
            <form action="{{ route('campaign.catalog.gift.apply.set_address', [$campaign_id, $gift->id]) }}" method="post" id="order_form">
                    ...
                    <div class="mt-3 mb-2">
                        ...
                        <select name="" id="used_address">
                            @foreach ($address_histories as $address)
                                <option value="" data-name01="{{ $address->last_name }}" data-name02="{{ $address->first_name }}" data-kana01="{{ $address->last_name_kana }}" data-kana02="{{ $address->first_name_kana }}" data-zip="{{ $address->post_code }}" data-pref="{{ $address->prefectures }}" data-add01="{{ $address->municipalities }}" data-add02="{{ $address->address_code }}" data-add03="{{ $address->building }}" data-tel="{{ $address->tel }}" data-delivery_time_id="{{ $address->delivery_time_id }}">{{ $address->getAddress() }}</option>
                            @endforeach
                        </select>
                    </div>
                @endif
                <div class="flex around mt-3 mb-2">
                    <div class="input_group">
                        <p>会社名・名前</p>
                        <input type="text" name="last_name" id="name01" class="required" value="{{ old('last_name', $default_address->last_name) }}">
                    ...
                    <!-- <div class="input_group">
                        <p>名</p>
                        <input type="text" name="first_name" id="name02" class="required" value="{{ old('first_name', $default_address->first_name) }}">
                        <p class="require_error">※必須項目です</p>
                    </div> -->
                </div>
                <div class="flex around mb-2">
                    <div class="input_group">
                        <p>フリガナ</p>
                        <input type="text" name="last_name_kana" id="kana01" class="required kana" value="{{ old('last_name_kana', $default_address->last_name_kana) }}">
                        <p class="require_error">※必須項目です</p>
                    ...
                    <!-- <div class="input_group">
                        <p>メイ</p>
                        <input type="text" name="first_name_kana" id="kana02" class="required kana" value="{{ old('first_name_kana', $default_address->first_name_kana) }}">
                        <p class="require_error">※必須項目です</p>
                        <p class="kana_error">※全角カナで入力してください</p>
                    </div> -->
                </div>
                <div class="bloc mb-2">
                    <p>郵便番号</p>
                    <input type="text" name="post_code" id="zip" class="required half" value="{{ old('post_code', $default_address->post_code) }}">
                ...
                <div class="bloc mb-2">
                    <p>都道府県</p>
                    <input type="text" name="prefectures" id="pref" class="required" value="{{ old('prefectures', $default_address->prefectures) }}">
                    <p class="require_error">※必須項目です</p>
                    @error('prefectures')
                        <p class="alert alert-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="bloc mb-2">
                    <p>市区町村</p>
                    <input type="text" name="municipalities" id="add01" class="required" value="{{ old('municipalities', $default_address->municipalities) }}">
                    <p class="require_error">※必須項目です</p>
                ...
                <div class="bloc mb-2">
                    <p>町名・番地</p>
                    <input type="text" name="address_code" id="add02" class="required" value="{{ old('address_code', $default_address->address_code) }}">
                    <p class="require_error">※必須項目です</p>
                    @error('address_code')
                        <p class="alert alert-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="bloc mb-2">
                    <p>建物名・号</p>
                    <input type="text" name="building" id="add03" value="{{ old('building', $default_address->building) }}">
                    @error('building')
                        <p class="alert alert-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="bloc mb-2">
                    <p>電話番号</p>
                    <input type="text" name="tel" id="tel" class="required half" value="{{ old('tel', $default_address->tel) }}">
                    <p class="require_error">※必須項目です</p>
                    <p class="half_error">※半角英数字で入力してください</p>
                    @error('tel')
                        <p class="alert alert-danger">{{ $message }}</p>
