...
$base_oil = filter_input(INPUT_POST,"base_oil");
...
$isShopNg = filter_input(INPUT_POST,"isShopNg");
...
$stmt->bindValue(':status_product', $status_product, PDO::PARAM_STR);
$stmt->bindValue(':status_oil', $status_oil, PDO::PARAM_STR);
$stmt->bindValue(':status_input', $status_input, PDO::PARAM_STR);
$stmt->bindValue(':status_diff', $status_diff, PDO::PARAM_STR);
$stmt->bindValue(':status_term', $status_term, PDO::PARAM_STR);
$stmt->bindValue(':status_shop', $status_shop, PDO::PARAM_STR);
$stmt->bindValue(':status_double', $status_double, PDO::PARAM_STR);
$stmt->bindValue(':status_ngword', $status_ngword, PDO::PARAM_STR);
$stmt->bindValue(':status_count', $status_count, PDO::PARAM_STR);
...
$stmt->bindValue(':base_oil', $base_oil, PDO::PARAM_STR);
$stmt->execute();
