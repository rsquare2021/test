                ...
                <div class="row layout-top-spacing">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            ...
                            <form action="{{ route('admin.meken.work') }}" method="get" id="re_select">
                                <div class="flex">
                                    <div class="bloc">
                                ...
                                <div class="flex mt-3">
                                    <div class="bloc">
                                        <select name="mk_company" id="mk_company" class="form-control fz12">
                                            <option value="">会社名を選択してください</option>
                                            @foreach($companies as $company)
                                                <option value="{{ $company->id }}" @if($mk_company == $company->id) selected @endif>{{ $company->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <tbody class="receipt_body">
                                        @foreach($receipts as $receipt)
                                            <tr id="{{ $receipt->id }}" data-userid="{{ $receipt->user_id }}">
                                                <td><a class="mb-2 re_confirm_btn merchant_img_get" data-toggle="modal" data-target="#editModal" data-receipt_path="{{ $receipt->receipt_path }}">{{ $receipt->receipt_id }}</a></td>
