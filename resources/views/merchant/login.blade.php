...
<head>
    ...
    <link href="/_merchant/css/style.css" rel="stylesheet" type="text/css" />
</head>
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">ログイン</h1>
                        <form class="text-left" action="{{ route('merchant.meken.login.send') }}" method="post">
                            @csrf
                            <div class="form">
	...
	<!-- <script src="/_merchant/js/auth_login.js"></script>
