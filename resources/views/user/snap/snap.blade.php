...
@include('user.snap.snap_load')
    ...
    <div class="user_wrap">
        <form action="{{ route('campaign.receipt.snap.send',$campaign_id) }}" method="post" enctype="multipart/form-data">
            ...
            <div id="snap_caution">
                @include('user.snap.snap_caution')
                <div class="snap_btn">
                    <label class="mt-4">
                        <i class="fas fa-camera"></i>
                        <input name="fileInput" id="fileInput" type="file" accept="image/*" capture="camera"/>撮影(カメラを起動)
                    </label>
                </div>
            </div>
            <div id="snap_result" class="mt-3">
                ...
                <div id="snap_ok">
                    <input style="display:none !important;" id="res_input" type="text" class="mb-2" disabled><span class="bold"></span>
                    ...
                    <div class="snap_btn">
                        <label class="mt-4">
                            <i class="fas fa-camera"></i>
                            <input name="re_fileInput" id="re_fileInput" type="file" accept="image/*" capture="camera"/>撮り直す(カメラを起動)
                        </label>
                    </div>
