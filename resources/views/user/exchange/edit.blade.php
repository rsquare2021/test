            ...
            <form action="{{ route('campaign.apply.address.update', [$campaign_id, $apply->id]) }}" method="post" id="order_form">
                ...
                <div class="flex around mt-3 mb-2">
                    <div class="input_group">
                        <p>会社名</p>
                        <input type="text" name="company_name" id="company_name" class="" value="{{ old('company_name', $address->company_name) }}">
                        @error('company_name')
                ...
                <div class="flex around mb-2">
                    <div class="input_group">
                        <p>名前</p>
                        <input type="text" name="personal_name" id="personal_name" class="required" value="{{ old('personal_name', $address->personal_name) }}">
                ...
                <div class="flex around mb-2">
                    <div class="input_group">
                        <p>フリガナ</p>
                        <input type="text" name="personal_name_kana" id="personal_name_kana" class="required kana" value="{{ old('personal_name_kana', $address->personal_name_kana) }}">
                        <p class="require_error">※必須項目です</p>
